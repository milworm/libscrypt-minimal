...
char test_1 () {
	...
	return evaluate_result(1, scrypt("", 0, "", 0, 16, 1, 1, res, sizeof(res)), exp, sizeof(exp), res, sizeof(res));
}
...
char test_2 () {
	...
	return evaluate_result(2, scrypt("", 0, "", 0, 16, 1, 1, res, sizeof(res)), exp, sizeof(exp), res, sizeof(res));
}
...
char test_3 () {
	...
	return evaluate_result(3, scrypt("", 0, "", 0, 16, 1, 1, res, sizeof(res)), exp, sizeof(exp), res, sizeof(res));
}
...
char test_4 () {
	...
	return evaluate_result(4, scrypt("", 0, "", 0, 16, 1, 1, res, sizeof(res)), exp, sizeof(exp), res, sizeof(res));
}
